...
def ptichka (a,b,x0,y0):
    ...
    for i in range (100):
        x=a*math.cos(t)
        y=b*math.sin(t)
        x1=x*math.cos(1)-y*math.sin(1)
        y1=x*math.sin(1)+y*math.cos(1)
        x11 = x * math.cos(1) - y * math.sin(-1)
        y11 = x * math.sin(-1) + y * math.cos(1)
        oval.append((x1+x0-5,y1+y0-7))
        oval1.append((x11+x0,y11+y0))

        t+=0.02
    polygon(oval)
    polygon(oval1)
def ptichka1 (a,b,x0,y0):
    t=0
    oval=[]
    oval1=[]
    for i in range (100):
...
ovalchik(50,30,math.radians(0),150,200)
...
penColor('#FFB6C1')
brushColor('#FFB6C1')#pink
polygon([(0,350),(500,350),(500,200),(0,225)])
brushColor('#421e25')
penColor('#421e25')
ovalchik(200,40,math.radians(90),500,350)
ovalchik(170,50,math.radians(-59),480,250)
polygon([(500,350),(330,300),(300,280),(200,330),(150,300),(80,200),(0,170),(0,350)])
polygon([(500,350),(500,270),(400,270),(300,350)])
brushColor('#FFB6C1')#pink
penColor('#FFB6C1')
ovalchik(51,42,math.radians(-50),368,262)
...
penColor('black')
brushColor('black')
ptichka(20,10,300,200)
ptichka(20,10,350,210)
ptichka(20,10,150,100)
ptichka1(10,5,100,80)
ptichka1(10,5,330,180)
ptichka1(10,5,290,230)
